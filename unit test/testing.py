...
class TestViolenceDetectionService(unittest.TestCase):
    ...
    #test case for the send notification function      
    ...
    #test case for the add log function
    ...
    #test case for the process prediction function
